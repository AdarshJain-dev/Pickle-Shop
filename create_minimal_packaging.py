...
def create_minimal_product(product_info):
    """Create MINIMAL product images with very short text"""
    ...
    try:
        ...
        hindi_font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 28)
        weight_font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 42)
    ...
    if product_info['type'] == 'jar':
        ...
        label_top = jar_top + 160
        label_width = 260  # SMALLER LABEL
        label_height = 280
        ...
        label_top = pouch_top + 110
        label_width = 240  # SMALLER LABEL
        label_height = 300

    # MINIMAL LABEL - VERY SHORT TEXT
    ...
    # Small orange header
    draw.rectangle([label_left, label_top, label_left + label_width, label_top + 38],
                  fill=(215, 95, 35))
    ...
    draw.text((center_x - brand_w // 2, label_top + 9), brand_text, fill=(255, 255, 255), font=brand_font)
    ...
    badge_y = label_top + 145
    draw.ellipse([badge_x, badge_y, badge_x + badge_size, badge_y + badge_size],
                fill=(195, 35, 35), outline=(135, 25, 25), width=3)
    ...
    draw.text((center_x - weight_w // 2, badge_y + (badge_size - weight_h) // 2 - 6),
             product_info['weight'], fill=(255, 255, 255), font=weight_font)

    # MINIMAL text at bottom
    bottom_y = label_top + label_height - 30
    draw.text((center_x - 50, bottom_y), "100% Natural", fill=(55, 95, 55), font=small_font)

    return img

# Products with SHORTEST names possible
products = [
    {"filename": "mango-pickle-1kg.jpg", "name": "MANGO", "hindi": "आम अचार",
     "weight": "1 KG", "type": "jar", "content_color": (255, 185, 70)},
    ...
    {"filename": "lemon-pickle-1kg.jpg", "name": "LEMON", "hindi": "नींबू अचार",
     "weight": "1 KG", "type": "jar", "content_color": (255, 230, 110)},
    ...
    {"filename": "lemon-chili-pickle-1kg.jpg", "name": "LEMON CHILI", "hindi": "नींबू मिर्च",
     "weight": "1 KG", "type": "jar", "content_color": (240, 90, 55)},
    ...
    {"filename": "amla-pickle-1kg.jpg", "name": "AMLA", "hindi": "आंवला अचार",
     "weight": "1 KG", "type": "jar", "content_color": (160, 205, 110)},
